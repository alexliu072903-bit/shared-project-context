...
When work may affect a shared project, read `project-context.json`, the personal goals file, and only the relevant project's `project.md` and `state.md`. Use the installed `project-publisher` Skill before publishing.
